...
### O script completo dessa atividade em formato .Rmd pode ser consultado [Aqui](https://github.com/Jhooreis/science.colab/blob/main/Atv/Atividade_final.Rmd,  "Repositório science.colab")
